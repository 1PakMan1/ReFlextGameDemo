...
package com.example.reflextgamedemo.google.facedetector

import android.content.Context
import android.util.Log
import com.example.reflextgamedemo.google.GraphicOverlay
import com.example.reflextgamedemo.google.processorbase.VisionProcessorBase
...
class FaceDetectorProcessor(context: Context, detectorOptions: FaceDetectorOptions?) :
    ...
    companion object {
        ...
        fun provideProcessorWithDefaultConfig(context: Context): FaceDetectorProcessor {
            val optionsBuilder = FaceDetectorOptions.Builder()
                ...
                .setMinFaceSize(0.1f)
                .enableTracking()
            return FaceDetectorProcessor(context, optionsBuilder.build())
        }
    }
}
